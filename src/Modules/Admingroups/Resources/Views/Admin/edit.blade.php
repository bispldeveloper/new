    ...
    <div class="module-header">
        <div class="row align-middle">
            <div class="small-12 large-6 columns">
                <p class="module-title"> Update Admingroup: {{ $admingroup->name }}</p>
            </div>
        </div>
    </div>

    {!! Form::model($admingroup, ['route' => ['mc-admin.admingroups.update', $admingroup->id], 'method' => 'PUT']) !!}
    <div class="row">
        <div class="small-12 large-6 columns">
            <div class="content-block">
                <p class="content-block-title">Update Admin Group</p>
                <div class="content">
                    <div class="row">
            ...
            <div class="button-block">
                <div class="row">
                    <div class="small-12 columns text-right">
                        {!! Form::submit('Save Admin Group', ['class' => 'button success']) !!}
                    </div>
                </div>
            </div>
        </div>
